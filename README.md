...
![image](https://github.com/Glibusss/Gleb_Makarenko_Spring2024_Highload/assets/113942267/6498eec4-108f-4b3d-a076-f0cff61e3ceb)
...
* Cleaning отвечает за периодическую очистку/архивацию файлов. Является частью Upload Manager
* Processing отвечает за обработку файлов(EX: Из одного изображения получается уменьшенная версия, оригинал, далее - всё хешируется и сжимается). Является частью Upload Manager
