...
MongoDB | репликация | Резервирование БД необходимо для сохранения данных в случае отказа работы одного из серверов БД, а также для обеспечения более высокой доступности и равномерного распределения нагрузки|
PSQL | репликация | --"--|
