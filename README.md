...
* Backend - будует использоваться уменьшение посылаемых запросов на проблемный хост и circuit breaker на случай отказов БД. В случае отказа БД, backend до восстановления будет кешировать данные, которые после восстановления будут туда записаны
