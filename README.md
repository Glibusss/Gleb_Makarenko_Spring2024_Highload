...
![image](https://github.com/Glibusss/Gleb_Makarenko_Spring2024_Highload/assets/113942267/1dc87031-fca2-4664-b63f-c5e52ce1a759)
...
* При отказе PSQL с сущностью канала, часть данных восстанавливается из Elastic с сохранением возможности подписаться
* При отказе ElasticSearch сервис может найти по внутренней логике необходимые данные из PSQL/MongoDB
