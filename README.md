...
* ```message```
   * ```content``` - частичное совпадение, допускаются различные формы слов
     Индекс: ```content```
     Обращение к ХД: По ```content```, возвращаются все частичные совпадения после приведения к upper_case

* ```post```
   * ```content``` - частичное совпадение, допускаются различные формы слов
   * ```channel_name``` - частичное совпадение
     Индексы(в порядке убывания важности): ```content```, ```channels.name```
     Обращение к ХД: по полю ```content```, возвращаются все частичные совпадения после приведения к upper_case, либо по полю ```channel_name```, возвращаются все частичные совпадения

* ```channel```
   * ```name``` - частичное совпадение, допускаются различные формы слов
     Индексы(в порядке убывания важности): ```name```, ```subscribers_count```
     Обращение к ХД: по полю ```name```, возвращаются все частичные совпадения после приведения к upper_case
